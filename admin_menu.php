            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                         <li class="nav-item"><a class="nav-link" href="henna_update.php">Henna History</a></li>
                        <li class="dropdown"><a class="nav-link" href="view_category.php" data-toggle="dropdown">Category</a>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="order_view_admin.php">View/Manage</a></li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="list_users.php">User List</a></li>
                         ...
                         <li class="nav-item"><a class="nav-link" href="feedback-index_admin.php">Feedback</a></li>
