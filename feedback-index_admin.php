...
<body>
   ...
   <div class="page-header clearfix">
                    ...
                    $orderBy = array('Product_id', 'Feedback', 'Responce', 'status');
                    $order = 'Feed_id';
                    ...
                    $sql = "SELECT * FROM feedback ORDER BY $order $sort LIMIT $offset, $no_of_records_per_page";
                    ...
                    if(!empty($_GET['search'])) {
                        ...
                        $sql = "SELECT * FROM feedback
                            WHERE CONCAT_WS (Product_id,Feedback,Responce,status)
                            LIKE '%$search%'
                            ORDER BY $order $sort
                    ...
                    if($result = mysqli_query($link, $sql)){
                        if(mysqli_num_rows($result) > 0){
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                echo "<thead>";
                                    echo "<tr>";
                                        echo "<th><a href=?search=$search&sort=&order=Product_id&sort=$sort>Product</th>";
										echo "<th><a href=?search=$search&sort=&order=Feedback&sort=$sort>Feedback</th>";
										echo "<th><a href=?search=$search&sort=&order=Responce&sort=$sort>Response</th>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                    echo "<td>" . $row['Product_id'] . "</td>";echo "<td>" . $row['Feedback'] . "</td>";echo "<td>" . $row['Responce'] . "</td>";echo "<td>" . $row['status'] . "</td>";
                                        echo "<td>";
										//praveen thappily
                                            //echo "<a href='feedback-read.php?Feed_id=". $row['Feed_id'] ."' title='View Record' data-toggle='tooltip'><i class='far fa-eye'></i></a>";
                                            echo "<a href='feedback-update.php?Feed_id=". $row['Feed_id'] ."' title='Update Record' data-toggle='tooltip'>Give Response<i class='far fa-edit'></i></a>";
