                ...
                <div class="col-lg-8 col-sm-12">
				   ...
				   <div class="list-view-box">
                                        <div class="row">
											...
											<form action="product_checkout.php" method="post" enctype="multipart/form-data">
                                           
                                              <div class="why-text full-width">
                                                    <h4>Product Name: <?php echo $_POST['name'];?></h4>
                                                <h5> Price: <?php echo $_POST['Amount'];?>/-</h5>
                                             
												 <p>Quantity :<?php echo $_POST['quantity'];?><br>
													 <h5>Total Price (Rs): <?php $q=$_POST['quantity'];$p=$_POST['Amount']; $t= $p*$q; echo $t;
														 ?></h5>/-<br>
												Payment method  <select name="payment"><option>Internet Banking</option><option>UPI</option></select>
												  <p>Please pay Rs.<?php echo $t;?>, using prefered payment method. </p>
												  
												  <p>Please upload a proof for the payment <input type="file" name="proof"></p>
												  
													  <input type="hidden" name="quantity" value="<?php echo $_POST['quantity'];?>"><br>
                                                  <input type="hidden" name="Product_id" value="<?php echo $_POST['Product_id'];?>">
												  <input type="hidden" name="price" value="<?php echo $t;?>"><br>
														
													
														  
														  
													 <input class="btn hvr-hover" type="submit" name="submit" value="Buy Now">
                                                </div>
                                    ...
                                    <div class="list-view-box">
                                        <div class="row">
                                            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                                <div class="products-single fix"></div>
                                            </div>
                                            <div class="col-sm-6 col-md-6 col-lg-8 col-xl-8"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
