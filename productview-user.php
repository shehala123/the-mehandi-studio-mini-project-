        ...
        <div class="container">
            <div class="row">
				...
				if(isset($_GET['categoryname']))
				   {
					   $sql="select*from product where  Catagory='".$_GET['categoryname']."'";
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
	...
	?>
				   <div class="list-view-box">
										...
										<form action="order-user.php" method="post">
                                            <div class="col-sm-6 col-md-6 col-lg-8 col-xl-8">
                                              <div class="why-text full-width">
                                                    <h4><?php echo $row['name'];?></h4>
                                                <h5> Rs. <?php echo $row['price'];?>/-</h5>
                                             
												 <p>Available :<?php echo $row['quantity']?><br>
													  <p>Quantity :<input type="number" name="quantity" max="<?php echo $row['quantity']?>"><br>
  ...
  echo "<tr><td><font color='red'>No Products in this category</font></td></tr>";
}
	?></td></tr>
