...
<body>
   ...
   <div class="page-header clearfix">
                        ...
                        <a href="feedback-create.php" class="btn btn-success float-right">New Feedback</a>
				...
				//	session_start();
					$uid=$_SESSION['uid'];
                    $sql = "SELECT * FROM feedback where uid=$uid ORDER BY $order $sort LIMIT $offset, $no_of_records_per_page";
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                echo "<thead>";
                                    echo "<tr>";
										...
										echo "<th><a href=?search=$search&sort=&order=Responce&sort=$sort>Admin's Response</th>";
