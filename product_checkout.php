...
//fileupload
$date=date('Y-m-d');
$prod_img= basename($_FILES["proof"]["name"]);
...
move_uploaded_file($_FILES["proof"]["tmp_name"], $target_file);
	...
	$sql="INSERT INTO `order_table` (`Order_id`, `Product_id`, `Quantity`, `Amount`, `Status`, `Date`, `UserId`, `PaymentMode`, `Receipt`) VALUES (NULL, '$Product_id', '$Quantity', '$Amount', 'Ordered', '$date', '$uid', '$PaymentMode', '$target_file')";
...
window.location='order_view_user.php';
</script>

<?php
	//header("Location: order_view_user.php");
	}
  ?>
