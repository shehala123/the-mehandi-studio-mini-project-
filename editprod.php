...
$prod_name=$_POST["prod_name"];
	...
	$sql="UPDATE product SET name = '$prod_name',image='$target_file',Catagory='$cat_name', price = '$prod_price', quantity= '$prod_qty', details = '$prod_details' WHERE id = '$prod_id'";
	echo $sql;
...
?>
<script>
alert("Record modified succesfully!");
</script>
...
<center>
	<form action="" method="post" enctype="multipart/form-data">
		 <table border="0">
			 <tr><td>Select Product you want to edit</td>
				 <td>
      <?php
...
if ($result->num_rows > 0) {
  ...
  echo "0 results";
	...
	?>
				...
				<tr><td> Name </td><td><input name="prod_name" type="text" autofocus="autofocus" required="required"></td></tr>
...
if ($result->num_rows > 0) {
  ...
  echo "0 results";
	...
	?></td></tr>
				...
				<tr><td>Price </td><td><input name="prod_price" type="text"  required="required"></td></tr>
				<tr><td>Quantity </td><td><input name="prod_qty" type="text" required="required"></td></tr>
				<tr><td>Details </td><td><textarea name="prod_details"></textarea></td></tr>
