...
<body>
 ...
 <?php
                    ...
                    $orderBy = array('Fullname', 'Username', 'Address', 'Email', 'Phone');
                    $order = 'uid';
                    ...
                    $sql = "SELECT * FROM registration ORDER BY $order $sort LIMIT $offset, $no_of_records_per_page";
					if(isset($_GET['id']))
					{ 
				$u=$_GET['id'];
				$sql = "SELECT * FROM registration where uid=$u ORDER BY $order $sort LIMIT $offset, $no_of_records_per_page";}
                    $count_pages = "SELECT * FROM registration";


                    if(!empty($_GET['search'])) {
                        $search = ($_GET['search']);
                        $sql = "SELECT * FROM registration
                            WHERE CONCAT_WS (Fullname,Username,Address,Email,Phone)
                            LIKE '%$search%'
                            ORDER BY $order $sort
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                echo "<thead>";
                                    echo "<tr>";
										...
										echo "<th><a href=?search=$search&sort=&order=Address&sort=$sort>Address</th>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                    echo "<td>" . $row['Fullname'] . "</td>";echo "<td>" . $row['Username'] . "</td>";echo "<td>" . $row['Address'] . "</td>";echo "<td>" . $row['Email'] . "</td>";echo "<td>" . $row['Phone'] . "</td>";
                                        echo "<td>";
										//praveen thappily
                                           echo "<a href='registration-delete.php?uid=". $row['uid'] ."' title='Delete Record' data-toggle='tooltip'><i class='far fa-trash-alt'></i></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";
