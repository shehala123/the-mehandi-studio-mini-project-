...
<head>
    ...
    <!-- Site Metas -->
    <title>the mehandi spl_autoload_extensions</title>
...
if ($result->num_rows > 0) {
  // output data of each row
	 ...
	 echo '<table border="1">
				<tr><th>Product</th><th>Image</th><th>Category</th><th>Price (Rs)</th><th>Quantity</th><th>Details</th></tr>';
  while($row = $result->fetch_assoc()) {
   echo "<tr><td>".$row['name']."</td><td><img src='".$row['image']."' width='200'></td><td>".$row['Catagory']."</td><td>".$row['price']."</td><td>".$row['quantity']."</td><td>".$row['details']."</td></tr>";
  }
