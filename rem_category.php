...
if(isset($_POST['submit']))
{
	...
	$sql="DELETE FROM `category` WHERE `category_id` =' $cat_name1'";
	//echo $sql;
...
<body>
	...
	<form action="" method="post">
		 <table border="0">
			 <tr><td>Select the Category you want to delete</td>
				 <td>
      <?php
...
if ($result->num_rows > 0) {
  ...
  echo "0 results";
	...
	?>
				...
				<!-- class="form-control" <div class="col-lg-4 col-sm-12">
    ...
    <!-- <div class="footer-copyright">
        <p class="footer-company">THE MEHANDI STUDIO &copy;  <a href="#"></a> 
